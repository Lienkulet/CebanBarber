...
const perks = [
  { icon: Scissors, title: "Master Barbers", desc: "Every cut by certified, experienced pros." },
  { icon: Star, title: "Premium Products", desc: "Top-shelf grooming products only." },
  { icon: Clock, title: "Walk-Ins Welcome", desc: "No appointment? No problem." },
  { icon: Shield, title: "Satisfaction Guaranteed", desc: "We make it right, every time." },
];
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* GSAP — fires on mount, targets data-hero="*" attributes */}
        <HeroReveal />
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-none mb-6">
            <span className="block overflow-hidden">
              <span data-hero="line" className="block text-offwhite">
                PRECISION <span className="text-gold-500">CUTS.</span>
              </span>
            </span>
            <span className="block overflow-hidden">
              <span data-hero="line" className="block text-offwhite">
                TIMELESS <span className="text-gold-500">STYLE.</span>
              </span>
            </span>
          </h1>
      ...
      <section className="bg-charcoal-950 border-y border-charcoal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <StaggerReveal className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8" stagger={0.1} y={30}>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <FadeIn x={-50} y={0} className="relative rounded-lg overflow-hidden aspect-4/5 bg-charcoal-800">
              <Image
                ...
                blurDataURL={BLUR_PLACEHOLDER}
              />
              {/* Gold badge with CountUp */}
              <div className="absolute bottom-6 left-6 bg-gold-500 text-charcoal-950 px-5 py-3 rounded">
                <CountUp end={1000} suffix="+" className="text-2xl font-extrabold leading-none" />
                <p className="text-xs font-semibold tracking-wider uppercase">Happy Clients</p>
              </div>
            </FadeIn>
            ...
            <FadeIn x={50} y={0}>
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-offwhite leading-tight mb-6">
                More Than a Haircut.{" "}
                <span className="text-gold-500">An Experience.</span>
              </h2>
              <p className="text-muted leading-relaxed mb-4">
                Founded by Nikita Ceban in 2024, CebanBarber was built on a
                simple belief: every man deserves to look and feel his best.
                From the moment you sit in our chair, you&apos;re in the hands of
                barbers dedicated to precision.
              </p>
              <p className="text-muted leading-relaxed mb-8">
                Modern barbering — precise fades, sharp lines, sculpted beards,
                and hot towel shaves. No rush. No shortcuts. Just sharp
                results every time.
              </p>
              <Link
                href="/services"
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            <FadeIn x={-40} y={0} className="relative rounded-lg overflow-hidden border border-charcoal-600 min-h-80">
              <iframe
              ...
              <div className="absolute bottom-4 left-4 flex items-center gap-2 bg-charcoal-900/90 backdrop-blur-sm border border-charcoal-600 rounded px-3 py-2">
                ...
                <span className="text-offwhite text-xs font-semibold tracking-wide">CebanBarber</span>
              </div>
              <a
                href={MAPS_LINK}
                target="_blank"
            ...
            <FadeIn x={40} y={0} className="flex flex-col justify-between gap-6">
              <StaggerReveal className="grid sm:grid-cols-2 gap-5" stagger={0.08} y={30}>
                {[
                  { icon: MapPin, label: "Address", value: businessInfo.address, href: MAPS_LINK, external: true },
                  { icon: Phone, label: "Phone", value: businessInfo.phone, href: `tel:${businessInfo.phone}`, external: false },
                  { icon: Mail, label: "Email", value: businessInfo.email, href: `mailto:${businessInfo.email}`, external: false },
                  { icon: Clock, label: "Today", value: "Mon – Fri: 9 AM – 7 PM", href: "/contact", external: false },
                  ...
                  >
                    ...
                    <div>
                      <p className="text-muted text-xs tracking-widest uppercase mb-0.5">{label}</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  Full Contact Info <ArrowRight size={15} />
                </Link>
                <a
