...
export default function ContactPage() {
  return (
    <>
      ...
      {/* Map — full-width, styled, fades in */}
      <FadeIn y={0} duration={1} className="relative w-full h-72 md:h-96 overflow-hidden border-b border-charcoal-600">
        <iframe
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <StaggerReveal className="space-y-10" stagger={0.12} y={35}>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-offwhite font-semibold mb-1">Address</h3>
                  <p className="text-muted text-sm leading-relaxed">{businessInfo.address}</p>
                  <a
                    href={MAPS_LINK}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-offwhite font-semibold mb-1">Phone</h3>
                  <a
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-offwhite font-semibold mb-1">Email</h3>
                  <a
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-offwhite font-semibold mb-3">Hours of Operation</h3>
            ...
            <FadeIn x={40} y={0} className="flex flex-col gap-6">
              ...
              <div className="bg-charcoal-800 border border-charcoal-600 rounded-lg p-8">
                ...
                <h3 className="text-offwhite font-bold text-2xl mb-3">Ready to Book?</h3>
                <p className="text-muted text-sm leading-relaxed mb-6">
                  Walk-ins are always welcome, but calling ahead ensures you get
                  your preferred barber and time slot without waiting.
                </p>
