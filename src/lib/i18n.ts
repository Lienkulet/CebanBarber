...
export const translations = {
  ...
  RO: {
    ...
    galleryAlts: {
      ...
      g4: "Tunsoare în desfășurare",
      g5: "Fade de precizie",
      g6: "Finisaj impecabil",
      g7: "Sculptarea bărbii",
      g8: "Stil signature",
      g9: "Frizerul în acțiune",
      g10: "Sesiune de styling",
    },
    weekdays: {
      Monday: "Luni",
      Tuesday: "Marți",
  ...
  RU: {
    ...
    galleryAlts: {
      ...
      g4: "Стрижка в процессе",
      g5: "Точный fade",
      g6: "Финальный результат",
      g7: "Скульптурирование бороды",
      g8: "Фирменный стиль",
      g9: "Барбер за работой",
      g10: "Сессия стайлинга",
    },
    weekdays: {
      Monday: "Понедельник",
      Tuesday: "Вторник",
